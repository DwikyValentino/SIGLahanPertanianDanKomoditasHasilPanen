  ...
  <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?=site_url('produksi/add')?>" class="btn btn-primary btn-flat">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center" width="160px">
                            <form action="<?=site_url('produksi/delete')?>" method="post">
                                <a href="<?=site_url('produksi/edit/'.$data->id_komoditas)?>" class="btn btn-warning btn-xs">
